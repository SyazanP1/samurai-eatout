...
public class AdminCategoryController {
	...
	public ResponseEntity<String> ajaxUpdate(@RequestBody Map<String, Object> payload) {
		Integer categoryId = Integer.parseInt((String) payload.get("categoryId"));
		String categoryName = (String) payload.get("categoryName");
		
		adminCategoryService.ajaxUpdateCategory(categoryId, categoryName);

		return ResponseEntity.ok("データ受信成功");
	}
}
